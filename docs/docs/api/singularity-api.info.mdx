...
>
  ...
  >
    ...
    >
      ...
      Token for successful authentication with email and password, indicating 2FA is required.
    ...
    >
      ...
      Token for step up authentication allowing access of secure resources.
