...
>
  ...
  >
    ...
    >
      ...
      Token for successful authentication with email and password, indicating 2FA is required.You can learn more [here](../../docs/guides/auth/tokens#two-factor-authentication-token).
    ...
    >
      ...
      Token for step up authentication allowing access of secure resources.You can learn more [here](../../docs/guides/auth/tokens#step-up-token).
