...
| singularity.ui.security-settings-uri  | `String` | The URI that will be included in security alert emails to redirect the user to their security settings.                       | `${singalarity.ui.base-uri}/me/settings#sessions` |
