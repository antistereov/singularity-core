 ...
 * @property mediaType The MIME type of the file (e.g., image/png, application/pdf).
...
sealed interface FileUploadRequest {
     ...
     *
     * @property key The unique identifier for the file, represented by a [FileRenditionKey].
     * @property mediaType The MIME type of the file (e.g., image/jpeg, application/pdf).
    ...
    data class FilePartUpload(
        override val key: FileRenditionKey,
     ...
     *
     * @property key A unique identifier for the file, represented by a [FileRenditionKey].
     * @property mediaType The MIME type of the file (e.g., image/png, application/pdf).
