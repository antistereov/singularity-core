package io.stereov.singularity.user.device.controller
...
class UserDeviceController(
     ...
     *
     * @return A [org.springframework.http.ResponseEntity] containing a list of [DeviceInfoResponse] objects representing the user's devices.
     */
    @GetMapping
