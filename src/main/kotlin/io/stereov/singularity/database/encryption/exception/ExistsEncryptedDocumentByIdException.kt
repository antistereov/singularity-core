 ...
 */
sealed class ExistsEncryptedDocumentByIdException(
    msg: String,
    code: String,
    status: HttpStatus,
    description: String,
     ...
     *
     * This exception is a subclass of [ExistsEncryptedDocumentByIdException].
     *
     ...
     */
    class Database(msg: String, cause: Throwable? = null) : ExistsEncryptedDocumentByIdException(
        msg,
