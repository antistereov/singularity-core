 ...
 */
sealed class DeleteAllEncryptedDocumentsException(
    msg: String,
    code: String,
    status: HttpStatus,
    description: String,
     ...
     *
     * This exception is a subclass of [DeleteAllEncryptedDocumentsException].
     *
     ...
     */
    class Database(msg: String, cause: Throwable? = null) : DeleteAllEncryptedDocumentsException(
        msg,
