package io.stereov.singularity.mail.user.config
...
import io.stereov.singularity.mail.user.service.MailCooldownService
...
class UserMailConfiguration {
    ...
    ) = UserMailService(userService, authenticationService, mailCooldownService, mailService, mailTokenService, hashService, userMapper)
