...
class BaseMailIntegrationTest {
    ...
    companion object {
        ...
        fun properties(registry: DynamicPropertyRegistry) {
            ...
            registry.add("baseline.mail.enable-verification") { true }
    ...
    fun `context loads`() {
        ...
        applicationContext.getBean(UserMailVerificationService::class.java)
        applicationContext.getBean(UserMailVerificationController::class.java)
    }
}
