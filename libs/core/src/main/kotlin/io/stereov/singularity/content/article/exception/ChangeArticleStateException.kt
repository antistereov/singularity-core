...
sealed class ChangeArticleStateException (
    msg: String,
    code: String,
    status: HttpStatus,
    description: String,
    ...
    class Database(msg: String, cause: Throwable? = null) : ChangeArticleStateException(
        msg,
    ...
    class NotAuthenticated(msg: String, cause: Throwable? = null) : ChangeArticleStateException(
        msg,
    ...
    class NotAuthorized(msg: String, cause: Throwable? = null) : ChangeArticleStateException(
        msg,
    ...
    class ContentNotFound(msg: String, cause: Throwable? = null): ChangeArticleStateException(
        msg,
    ...
    class File(msg: String, cause: Throwable? = null) : ChangeArticleStateException(
        msg,
        FileFailure.CODE,
        FileFailure.STATUS,
    ...
    class ResponseMapping(msg: String, cause: Throwable? = null) : ChangeArticleStateException(
        msg,
    ...
    companion object {
        ...
        fun from(ex: FindContentAuthorizedException): ChangeArticleStateException {
            return when (ex) {
