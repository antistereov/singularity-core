 ...
 */
sealed class FindEncryptedDocumentByIdException(
    msg: String,
    code: String,
    status: HttpStatus,
    description: String,
     ...
     *
     * This exception is a subclass of [FindEncryptedDocumentByIdException].
     *
    ...
    companion object {
        ...
        /**
         * Maps a provided [DatabaseException] to its corresponding [FindEncryptedDocumentByIdException] subtype.
         *
         ...
         * @return The corresponding [FindEncryptedDocumentByIdException] instance.
         */
        @Suppress("UNUSED")
        fun fromDatabaseException(ex: DatabaseException): FindEncryptedDocumentByIdException {
            return when (ex) {
