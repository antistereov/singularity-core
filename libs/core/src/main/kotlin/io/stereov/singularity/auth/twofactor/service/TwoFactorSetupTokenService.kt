...
import io.stereov.singularity.auth.twofactor.model.TwoFactorSetupToken
...
class TwoFactorSetupTokenService(
    ...
    suspend fun create(userId: ObjectId, secret: String, recoveryCodes: List<String>, issuedAt: Instant = Instant.now()): TwoFactorSetupToken {
        ...
        return TwoFactorSetupToken(secret, recoveryCodes, jwt)
    }

    suspend fun validate(token: String): TwoFactorSetupToken {
        ...
        return TwoFactorSetupToken(secret, recoveryCodeStrings, jwt)
    }
}