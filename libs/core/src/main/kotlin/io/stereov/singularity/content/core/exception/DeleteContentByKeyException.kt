...
sealed class DeleteContentByKeyException(
    msg: String, 
    code: String, 
    status: HttpStatus,
    description: String,
    ...
    class NotAuthenticated(msg: String, cause: Throwable? = null) : DeleteContentByKeyException(
        msg,
    ...
    class NotAuthorized(msg: String, cause: Throwable? = null) : DeleteContentByKeyException(
        msg,
    ...
    class ContentNotFound(msg: String, cause: Throwable? = null): DeleteContentByKeyException(
        msg,
    ...
    class Database(msg: String, cause: Throwable? = null) : DeleteContentByKeyException(
        msg,
