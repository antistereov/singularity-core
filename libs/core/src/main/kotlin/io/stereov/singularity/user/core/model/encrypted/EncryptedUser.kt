package io.stereov.singularity.user.core.model.encrypted
 ...
 * @property roles The set of [Role.User] assigned to the user, defining their permissions and access level.
