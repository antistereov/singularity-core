 ...
 */
sealed class SaveEncryptedDocumentException(
    msg: String,
    code: String,
    status: HttpStatus,
    description: String,
     ...
     */
    class Database(msg: String, cause: Throwable? = null) : SaveEncryptedDocumentException(
        msg,
     ...
     */
    class Encryption(msg: String, cause: Throwable? = null) : SaveEncryptedDocumentException(
        msg,
     ...
     */
    class PostCommitSideEffect(msg: String, cause: Throwable? = null) : SaveEncryptedDocumentException(
        msg,
