 ...
 */
sealed class ExistsDocumentByKeyException(
    msg: String,
    code: String,
    status: HttpStatus,
    description: String,
     ...
     *
     * This exception is a subtype of [ExistsDocumentByKeyException] and is used to indicate
     ...
     */
    class Database(msg: String, cause: Throwable? = null) : ExistsDocumentByKeyException(
        msg,
